<?php
/*
 * Template Name: RRU R in 3 Months
 */
  ...
  <main class="px-4 mx-auto mt-2 max-w-screen-full">
    ...
    <div class="bg-white">
      ...
      <div class="max-w-2xl mx-auto mt-16">
        <!-- <p class="mt-16 text-xl font-bold leading-relaxed text-blue-900">I’ve often been asked: “how long does it take to learn R?” I’ve never had a good answer ... until now. </p>
          ...
          <div class="px-4 py-12 sm:px-6 md:flex md:flex-col md:py-16 md:pl-0 md:pr-10 md:border-r md:border-gray-900 lg:pr-16">
            ...
            <blockquote class="mt-6 md:flex-grow md:flex md:flex-col">
              <div class="relative text-lg font-medium text-white md:flex-grow">
                ...
                <p class="relative text-white">
                  I joined the R for the Rest of Us course with high expectations, and my expectations were blown away. The level of individualized coaching and feedback was extraordinary. I highly recommend making time to take this course!
                </p>
              </div>
              <footer class="mt-8">
                <div class="flex items-start">
              ...
              <div class="px-4 py-12 mx-auto mb-16 text-center max-w-7xl sm:px-6 lg:pt-24 lg:pb-12 lg:px-8">
                ...
                <div class="flex justify-center mt-8">
                  <div class="inline-flex rounded-md shadow">
                    <a href="#pricing" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md hover:text-white">
                      Sign Up Now
                    </a>
                  </div>
