...
<div id="primary" class="content-area">
  ...
  <h1 class="rru-page-title">
      ...
      <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-screen-xl lg:px-8">
        <div class="lg:grid lg:grid-cols-2 lg:gap-8">
          ...
          <div class="mt-10 lg:mt-0">
            ...
            <div class="p-3 bg-gray-200 border-2 border-gray-300 rounded-md relative">
    ...
    <div class="flex flex-wrap -mx-5 overflow-hidden mt-8">

      <div class="my-5 px-5 w-full overflow-hidden md:w-1/2 text-base text-blue-800">

        <h2 class="text-3xl my-8 leading-8 font-extrabold text-blue-800 tracking-tight sm:leading-9">
      ...
      <div class="my-5 px-5 w-full overflow-hidden md:w-1/2">
        ...
        <img class="mx-auto px-32 py-16" src="/wp-content/themes/buddyboss-theme-child/assets/images/rru-logo-blue.svg" alt=" R for the Rest of Us logo">
    ...
    <div class="lg:grid lg:grid-cols-12 lg:gap-8 mt-8">
      ...
      <div class="sm:text-center leading-8 md:max-w-2xl md:mx-auto lg:col-span-8 lg:text-left">
