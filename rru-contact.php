            ...
            <div class="grid grid-cols-1 lg:grid-cols-3">
              ...
              <div class="relative overflow-hidden bg-gradient-to-b from-blue-500 to-blue-600 py-10 px-6 sm:px-10 xl:p-12">
                ...
                <dl class="mt-8 space-y-6">
                  ...
                  <dd class="flex text-base text-blue-50 ml-0">
                    <!-- Heroicon name: outline/phone -->
                    <svg class="h-6 w-6 flex-shrink-0 text-blue-200" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" />
                    </svg>
                    <span class="ml-1">(503) 395-4385</span>
                  </dd>
                  ...
                  <dd class="flex text-base text-blue-50 ml-0">
                    ...
                    <span class="ml-1">david@rfortherestofus.com</span>
                  </dd>
                </dl>
                <ul role="list" class="mt-8 flex space-x-12 invisible">
                  <li>
