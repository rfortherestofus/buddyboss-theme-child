...
<div id="primary" class="content-area bb-grid-cell">
    ...
    <main id="main" class="site-main mt-10">
        ...
        <div class="flex flex-wrap overflow-hidden mt-16">
            ...
            <div class="w-full overflow-hidden sm:hidden">
                ...
                <div class="sm:mt-32 w-2/3 mx-auto">
                    ...
                    <div class="mt-5 sm:mt-12 mb-20">
                        <a href="/courses/fundamentals/" class="px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-blue-600 hover:text-white hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                            Learn More
                        </a>
        ...
        <div class="flex flex-wrap overflow-hidden mt-16">
            ...
            <div class="w-full overflow-hidden md:my-3 md:px-3 md:w-1/2">
                <img class="" src="/wp-content/themes/buddyboss-theme-child/assets/images/going-deeper.svg" alt="Going Deeper with R" />
            </div>
            ...
            <div class="w-full overflow-hidden md:my-3 md:px-3 md:w-1/2">
                <div class="w-2/3 mx-auto">
                    ...
                    <p class="mt-4 mb-4 text-blue-800 leading-relaxed">
                    ...
                    <div class="mt-5 sm:mt-12 mb-20">
                        <a href="/courses/going-deeper/" class="px-8 py-3 border border-transparent text-base leading-6 font-medium rounded-md text-white bg-blue-600 hover:text-white hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-blue transition duration-150 ease-in-out md:py-4 md:text-lg md:px-10">
                            Learn More
                        </a>
