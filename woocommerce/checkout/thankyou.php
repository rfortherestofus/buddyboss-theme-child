...
<div class="woocommerce-order">
	...
	if ($order) :
		...
		<div class="woocommerce-order-over">
			...
			<?php else : ?>
				...
				<p>While you're here, I'd love to know a bit more about who you are and what brings you here.</[]>

					<?php echo do_shortcode("[ninja_form id=22]"); ?>
	...
	<?php else : ?>
		...
		<p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters('woocommerce_thankyou_order_received_text', esc_html__('Thank you. Your order has been received.', 'buddyboss-theme'), null); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped 
																										?></p>
