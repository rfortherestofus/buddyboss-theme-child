<?php
/*
 * Template Name: RRU R in 3 Feedback Fall 2022
 */
...
<div id="primary" class="content-area">
  ...
  <main class="px-4 mx-auto mt-2 max-w-screen-full visible_to_course_32106">
  ...
  <h1 class="leading-none rru-page-title">
      R in 3 Months Feedback (Fall 2022)
    </h1> 
    ...
    <div class="md:max-w-3xl">
      <p>
        This page collects feedback for R in 3 Months (Fall 2022) participants. Use the filters below to find what you're looking for.
        </p>
        </div>
    ...
    <?php echo do_shortcode("[facetwp template='r_in_3_feedback_fall_2022']"); ?>
